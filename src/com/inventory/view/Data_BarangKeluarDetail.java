...
public class Data_BarangKeluarDetail extends javax.swing.JDialog {

    int xx, xy;
    
    
    private Service_DetBarangKeluar servis = new DAO_DetBarangKeluar();
    private TableMod_DetBarangKeluar tblModel = new TableMod_DetBarangKeluar();
    
    public Model_BarangKeluar psn = new Model_BarangKeluar();
    public Model_DetBarangKeluar dbm = new Model_DetBarangKeluar();
    public Model_Barang mbm = new Model_Barang();
    
    public Data_BarangKeluarDetail(java.awt.Frame parent, boolean modal,String id) {
        super(parent, modal);
        initComponents();
...
//        pencarian();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Data_BarangKeluarDetail dialog = new Data_BarangKeluarDetail(new javax.swing.JFrame(), true,"BM241016001");
...
//        tblModel.setData(list);
    ...
    private void loadData(String id) {
        List<Model_DetBarangKeluar> list = servis.getData(id);
        tblModel.setData(list);
    }

...
public class Data_Pengangkut extends javax.swing.JDialog {
    ...
    public Model_Pengangkut model = new Model_Pengangkut();
    
    public Data_Pengangkut(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Data Pengangkut");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Data_Pengangkut.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Data_Pengangkut dialog = new Data_Pengangkut(new javax.swing.JFrame(), true);
    ...
    private void pencarian() {
        List<Model_Pengangkut> list = servis.pencarian(txtSearch.getText());
    ...
    private void loadData() {
        ...
        List<Model_Pengangkut> list = servis.getData(startIndex, dataPerHalaman);
        tblModel.setData(list);
    }
    ...
    private void pilihData() {
        ...
        model.setKode_pengangkut(tblData.getModel().getValueAt(row, 1).toString());
        model.setNama_pengangkut(tblData.getModel().getValueAt(row, 2).toString());
        dispose();
    }
